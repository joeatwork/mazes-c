...
CFLAGS=-D_GNU_SOURCE -I/usr/include/glib-2.0 -I/usr/include/graphviz -I/usr/lib/x86_64-linux-gnu/glib-2.0/include -g -Wall -Werror -O3 -std=c11
LDFLAGS= -lm -lglib-2.0 -lcgraph
